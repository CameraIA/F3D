...
void MMdil3DInit(global const uchar* inputBuffer, 
                 global uchar* outputBuffer, 
                 int3 pos, 
                 int3 sizes, 
                 global const uchar* structElem, 
                 int3 structElemSizes,
                 global const long* zIbits, 
                 global const long* zJbits,
                 global const long* zKbits)
{
    int v0 =  getValue(inputBuffer, pos, sizes, zIbits, zJbits, zKbits);
    ...
    setValue(outputBuffer, pos, sizes, maxx, zIbits, zJbits, zKbits);
}
                         ...
                         global const long* zKbits)
{
    ...
    for(int i = 0; i < imageDepth; ++i)
    {
        ...
        MMdil3DInit(inputBuffer, outputBuffer, pos, sizes, structElem, structElemSizes, zIbits, zJbits, zKbits);
    }
}


void MMdil3D(global const uchar* inputBuffer, 
                         ...
                         global const long* zKbits)
{
    ...
    {
        int3 pos = { get_global_id(0), get_global_id(1), i };    
        MMdil3D(inputBuffer, tmpBuffer, outputBuffer, pos, sizes, structElem, structElemSizes, zIbits, zJbits, zKbits);
    }
}
